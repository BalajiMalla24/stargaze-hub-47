  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="relative h-[80vh] bg-cover bg-center flex items-center" style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.7)), url(https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)' }}>
        ...
        <section className="py-12 bg-white border-b">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-12 items-center justify-items-center opacity-70">
              {['SpaceX', 'Stripe', 'ByteDance', 'Epic Games', 'Instacart'].map((company, index) => (
                <div key={index} className="flex items-center justify-center">
                  <img 
                    ...
                    alt={company} 
                    className="h-10 md:h-12 w-auto filter grayscale"
                  />
                </div>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-t-4 border-t-stargaze-purple">
                <CardContent className="pt-6">
                  <h3 className="text-xl font-bold mb-3">Disciplined Selection Process</h3>
                  <p className="text-gray-600">
                    Our multi-dimensional assessment framework evaluates companies based on market positioning, 
                    competitive advantage, and long-term value creation potential.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-amber-400">
                <CardContent className="pt-6">
                  <h3 className="text-xl font-bold mb-3">Balanced Portfolio Construction</h3>
                  <p className="text-gray-600">
                    We maintain a diversified approach across sectors, geographies, and growth stages
                    to optimize risk-adjusted returns throughout market cycles.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-t-4 border-t-gray-800">
                <CardContent className="pt-6">
                  <h3 className="text-xl font-bold mb-3">Alignment of Interests</h3>
                  <p className="text-gray-600">
                    We prioritize investments where management teams have significant ownership stakes,
                    ensuring aligned incentives for sustainable growth.
                  </p>
                </CardContent>
              </Card>
            </div>
