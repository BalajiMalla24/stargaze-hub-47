...
const CompanyCard = ({ logo, name, description, valuation, totalBlockSize, investors }: CompanyCardProps) => {
  return (
    <Card className="h-full hover:shadow-md transition-shadow">
      ...
      <CardContent>
        ...
        <div className="mt-4 text-right">
          <a href="#" className="text-stargaze-purple text-sm hover:underline">
            Learn more...
          </a>
        </div>
      </CardContent>
